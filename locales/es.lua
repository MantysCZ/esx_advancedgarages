Locales['es'] = {
	...
	['3d_press_to_enter'] = 'Presiona [~g~E~s~] sacar el vehículo del garaje.',
	['3d_press_to_delete'] = 'Presiona [~g~E~s~] para almacenar el vehículo en el garaje',
	['3d_press_to_impound'] = 'Presiona [~g~E~s~] para acceder al depósito.',
