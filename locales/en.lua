Locales['en'] = {
	...
	['3d_press_to_enter'] = 'Press [~g~E~s~] to take Vehicle out of Garage.',
	['press_to_delete'] = 'Press ~INPUT_PICKUP~ to store Vehicle in the Garage.',
	['3d_press_to_delete'] = 'Press [~g~E~s~] to store Vehicle in the Garage',
	['press_to_impound'] = 'Press ~INPUT_PICKUP~ to access the Impound.',
	['3d_press_to_impound'] = 'Press [~g~E~s~] to access the Impound.',
	['you_paid'] = 'You paid $',
